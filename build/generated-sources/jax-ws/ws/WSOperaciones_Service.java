 ...
 * 
 */
@WebServiceClient(name = "WSOperaciones", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:8080/ServicioWebSoap/WSOperaciones?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/ServicioWebSoap/WSOperaciones?WSDL");
    ...
    public WSOperaciones getServiciosPort() {
